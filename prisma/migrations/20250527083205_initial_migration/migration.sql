...
CREATE TABLE "UpdateContent" (
    ...
    CONSTRAINT "UpdateContent_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "UpdateContent" ADD CONSTRAINT "UpdateContent_updateId_fkey" FOREIGN KEY ("updateId") REFERENCES "Update"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
